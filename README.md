...
* There are PRs/issues to make some tweaks in some of the involved repos. 
    ...
    * [Allow users to provide the name of the sketch they want timelines to be part of if it exists](https://github.com/openrelik/openrelik-worker-timesketch/pull/8)
